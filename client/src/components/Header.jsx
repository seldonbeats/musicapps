...
const Header = () => {
  ...
  return (
    <header className="flex items-center w-full p-4 md:py-2 md:px-6">
      <NavLink to={"/Home"}>
        <img src={Logo} className="w-14 flex justify-center items-center" alt="" />
      </NavLink>
      ...
      <ul className="flex items-center justify-center ml-7">
        ...
        {/* prettier-ignore */}
        <li className="mx-5 text-lg"><NavLink to={'/drumkit'} className={({ isActive }) => isActive ? isActiveStyles : isNotActiveStyles}>Drum-Kit</NavLink></li>
        {/* prettier-ignore */}
        <li className="mx-5 text-lg"><NavLink to={'/price'} className={({ isActive }) => isActive ? isActiveStyles : isNotActiveStyles}>Price</NavLink></li>
        {/* prettier-ignore */}
      ...
      <div className="flex items-center ml-auto px-8 cursor-pointer gap-2 relative">
        <NavLink to={"/cart/:id?"}>
          <FaCartPlus className="text-2xl -ml-1 text-yellow-500" />
        </NavLink>
      </div>
